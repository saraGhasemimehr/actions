...
function showMeme() {
 ...
 document.querySelector('.content').appendChild(memeImage);
...
function showJoke() {
 ...
 document.querySelector('.content').innerHTML = randomJokeText;
}
...
function showRiddle() {
  ...
  document.querySelector('.content').innerHTML = randomRiddle.question;
}
...
function revealAnswers() {
  const randomRiddle = getRandomData('riddles');
  document.querySelector('.content').innerHTML = randomRiddle.answer;
